  ...
  return (
    <div className="flex flex-col justify-center items-center p-5 h-[90vh] gap-16 ">
      ...
      <div className="grid grid-cols-2 gap-5 md:grid-cols-none md:grid-rows-none md:flex">
        ...
        >
          <FlexCard label="Learing"  className="text-white  font-bold"/>
        </div>
        <div
          onClick={() => navigatemood("relaxation")}
